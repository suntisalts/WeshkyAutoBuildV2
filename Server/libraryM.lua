...
local TOUCH_SCALE = IS_MOBILE and 1.5 or 1 -- Scale up for mobile
...
do -- Load items
    ...
    imgui2.ResetOnSpawn = false

    Presets.Name = "Presets"
    Presets.Parent = imgui2
    Presets.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Presets.Size = UDim2.new(0, 100 * TOUCH_SCALE, 0, 100 * TOUCH_SCALE)
    ...
    Label.Size = UDim2.new(0, 91 * TOUCH_SCALE, 0, 15 * TOUCH_SCALE)
    Label.Font = tzu
    Label.Text = "Hello, World!"
    Label.TextColor3 = Color3.fromRGB(255, 255, 255)
    Label.TextSize = 13.000 * TOUCH_SCALE
    ...
    TabButton.Size = UDim2.new(0, 32 * TOUCH_SCALE, 1, 0)
    TabButton.Font = tzu
    TabButton.Text = "Menu"
    TabButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    TabButton.TextSize = 16.000 * TOUCH_SCALE
    ...
    Folder.Size = UDim2.new(1, 0, 0, 100 * TOUCH_SCALE)
    ...
    Folder_2.Size = UDim2.new(1, 0, 0, 20 * TOUCH_SCALE)
    ...
    Expand.Position = UDim2.new(0, 6 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    Expand.Size = UDim2.new(0, 16 * TOUCH_SCALE, 0, 16 * TOUCH_SCALE)
    Expand.ZIndex = 4
    ...
    Title.Position = UDim2.new(0, 30 * TOUCH_SCALE, 0, 0)
    Title.Size = UDim2.new(1, -30 * TOUCH_SCALE, 1, 0)
    Title.Font = tzu
    Title.Text = "Folder"
    Title.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title.TextSize = 13.000 * TOUCH_SCALE
    ...
    Items.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 25 * TOUCH_SCALE)
    Items.Size = UDim2.new(1, -10 * TOUCH_SCALE, 1, -25 * TOUCH_SCALE)

    UIListLayout.Parent = Items
    UIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    UIListLayout.Padding = UDim.new(0, 5 * TOUCH_SCALE)

    Tab.Name = "Tab"
    Tab.Parent = Presets
    Tab.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Tab.BackgroundTransparency = 1.000
    Tab.Position = UDim2.new(0, 0, 0, 30 * TOUCH_SCALE)
    Tab.Size = UDim2.new(1, 0, 1, -30 * TOUCH_SCALE)
    ...
    Items_2.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 0)
    Items_2.Size = UDim2.new(1, -20 * TOUCH_SCALE, 1, 0)
    Items_2.CanvasSize = UDim2.new(0, 0, 0, 0)
    Items_2.ScrollBarThickness = 6 * TOUCH_SCALE

    UIListLayout_2.Parent = Items_2
    UIListLayout_2.SortOrder = Enum.SortOrder.LayoutOrder
    UIListLayout_2.Padding = UDim.new(0, 5 * TOUCH_SCALE)
    ...
    Main.Size = UDim2.new(0, 300 * TOUCH_SCALE, 0, 22 * TOUCH_SCALE)
    Main.ZIndex = 4
    ...
    Frame.Position = UDim2.new(0, 0, 1, -10 * TOUCH_SCALE)
    Frame.Size = UDim2.new(1, 0, 0, 10 * TOUCH_SCALE)
    Frame.ZIndex = 4
    ...
    Frame_2.Size = UDim2.new(1, 0, 0, 2 * TOUCH_SCALE)
    Frame_2.ZIndex = 2
    ...
    Content.Size = UDim2.new(1, 0, 0, 200 * TOUCH_SCALE)
    ...
    Frame_3.Size = UDim2.new(1, 0, 0, 10 * TOUCH_SCALE)

    Message.Name = "Message"
    Message.Parent = Content
    Message.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Message.BackgroundTransparency = 1.000
    Message.Position = UDim2.new(0, 0, 0, -22 * TOUCH_SCALE)
    Message.Size = UDim2.new(1, 0, 1, 22 * TOUCH_SCALE)
    Message.ZIndex = 3
    ...
    Expand_2.Position = UDim2.new(0, 6 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    Expand_2.Rotation = 90.000
    Expand_2.Size = UDim2.new(0, 18 * TOUCH_SCALE, 0, 18 * TOUCH_SCALE)
    Expand_2.ZIndex = 4
    ...
    Title_2.Position = UDim2.new(0, 30 * TOUCH_SCALE, 0, 0)
    Title_2.Size = UDim2.new(1, -30 * TOUCH_SCALE, 1, 0)
    Title_2.ZIndex = 4
    Title_2.Font = tzu2
    Title_2.Text = "ImGui Demo"
    Title_2.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title_2.TextSize = 15 * TOUCH_SCALE
    ...
    Shadow.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 10 * TOUCH_SCALE)
    ...
    Tabs.Position = UDim2.new(0, 0, 1, 2 * TOUCH_SCALE)
    Tabs.Size = UDim2.new(1, 0, 0, 28 * TOUCH_SCALE)

    Items_3.Name = "Items"
    Items_3.Parent = Tabs
    Items_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Items_3.BackgroundTransparency = 1.000
    Items_3.Position = UDim2.new(0, 15 * TOUCH_SCALE, 0, 0)
    Items_3.Size = UDim2.new(1, -15 * TOUCH_SCALE, 1, -2 * TOUCH_SCALE)

    UIListLayout_3.Parent = Items_3
    UIListLayout_3.FillDirection = Enum.FillDirection.Horizontal
    UIListLayout_3.SortOrder = Enum.SortOrder.LayoutOrder
    UIListLayout_3.Padding = UDim.new(0, 15 * TOUCH_SCALE)

    Frame_4.Parent = Tabs
    Frame_4.BackgroundColor3 = Color3.fromRGB(59, 59, 68)
    Frame_4.BorderSizePixel = 0
    Frame_4.Position = UDim2.new(0, 0, 1, -2 * TOUCH_SCALE)
    Frame_4.Size = UDim2.new(1, 0, 0, 2 * TOUCH_SCALE)
    Frame_4.ZIndex = 2
    ...
    Layer.Position = UDim2.new(0, 2 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    ...
    Dock.Size = UDim2.new(1, 0, 0, 22 * TOUCH_SCALE)

    UIListLayout_4.Parent = Dock
    UIListLayout_4.FillDirection = Enum.FillDirection.Horizontal
    UIListLayout_4.SortOrder = Enum.SortOrder.LayoutOrder
    UIListLayout_4.Padding = UDim.new(0, 5 * TOUCH_SCALE)

    Switch.Name = "Switch"
    Switch.Parent = Presets
    Switch.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Switch.BackgroundTransparency = 1.000
    Switch.Size = UDim2.new(0, 70 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
    ...
    Button.Size = UDim2.new(0, 20 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
    Button.ZIndex = 3
    Button.Font = tzu
    Button.Text = ""
    Button.TextColor3 = Color3.fromRGB(255, 255, 255)
    Button.TextSize = 13.000 * TOUCH_SCALE
    ...
    Layer_2.Position = UDim2.new(0.5, 2 * TOUCH_SCALE, 0.5, 2 * TOUCH_SCALE)
    ...
    Check.Position = UDim2.new(0, 3 * TOUCH_SCALE, 0, 3 * TOUCH_SCALE)
    Check.Size = UDim2.new(1, -6 * TOUCH_SCALE, 1, -6 * TOUCH_SCALE)
    Check.ZIndex = 2
    ...
    Text.Position = UDim2.new(0, 28 * TOUCH_SCALE, 0, 0)
    Text.Size = UDim2.new(0, 42 * TOUCH_SCALE, 1, 0)
    Text.Font = tzu
    Text.Text = "Switch"
    Text.TextColor3 = Color3.fromRGB(255, 255, 255)
    Text.TextSize = 13.000 * TOUCH_SCALE
    ...
    Slider.Size = UDim2.new(0, 150 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)

    Outer.Name = "Outer"
    Outer.Parent = Slider
    Outer.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Outer.BackgroundTransparency = 1.000
    Outer.Size = UDim2.new(0, 150 * TOUCH_SCALE, 1, 0)
    ...
    Inner.Position = UDim2.new(0, 2 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    Inner.Size = UDim2.new(1, -4 * TOUCH_SCALE, 1, -4 * TOUCH_SCALE)
    ...
    Slider_2.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 0)
    Slider_2.Size = UDim2.new(0, 5 * TOUCH_SCALE, 1, 0)
    ...
    Value.TextSize = 13.000 * TOUCH_SCALE

    Text_2.Name = "Text"
    Text_2.Parent = Slider
    Text_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Text_2.BackgroundTransparency = 1.000
    Text_2.Position = UDim2.new(0, 158 * TOUCH_SCALE, 0, 0)
    Text_2.Size = UDim2.new(0, 42 * TOUCH_SCALE, 1, 0)
    Text_2.Font = tzu
    Text_2.Text = "Slider"
    Text_2.TextColor3 = Color3.fromRGB(255, 255, 255)
    Text_2.TextSize = 13.000 * TOUCH_SCALE
    ...
    Button_2.Size = UDim2.new(0, 72 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
    Button_2.ZIndex = 3
    Button_2.Font = tzu
    Button_2.TextColor3 = Color3.fromRGB(255, 255, 255)
    Button_2.TextSize = 13.000 * TOUCH_SCALE
    ...
    Layer_3.Position = UDim2.new(0.5, 2 * TOUCH_SCALE, 0.5, 2 * TOUCH_SCALE)
    ...
    Card.Size = UDim2.new(1, 0, 0, 100 * TOUCH_SCALE)
    ...
    ImageLabel_3.Position = UDim2.new(0, 24 * TOUCH_SCALE, 0, 24 * TOUCH_SCALE)
    ImageLabel_3.Size = UDim2.new(0, 52 * TOUCH_SCALE, 1, -48 * TOUCH_SCALE)
    ...
    Roundify.Size = UDim2.new(1, 24 * TOUCH_SCALE, 1, 24 * TOUCH_SCALE)
    Roundify.ZIndex = 3
    ...
    heading.Position = UDim2.new(0, 100 * TOUCH_SCALE, 0, 24 * TOUCH_SCALE)
    heading.Size = UDim2.new(1, -100 * TOUCH_SCALE, 0, 50 * TOUCH_SCALE)
    heading.ZIndex = 3
    heading.Font = tzu
    heading.Text = "welcome, singularity"
    heading.TextColor3 = Color3.fromRGB(255, 255, 255)
    heading.TextSize = 13.000 * TOUCH_SCALE
    ...
    SubHeading.Position = UDim2.new(0, 100 * TOUCH_SCALE, 0, 44 * TOUCH_SCALE)
    SubHeading.Size = UDim2.new(1, -100 * TOUCH_SCALE, 0, 50 * TOUCH_SCALE)
    SubHeading.ZIndex = 3
    SubHeading.Font = tzu
    SubHeading.Text = "subheading"
    SubHeading.TextColor3 = Color3.fromRGB(255, 255, 255)
    SubHeading.TextSize = 13.000 * TOUCH_SCALE
    ...
    ColorPicker.Size = UDim2.new(0, 112 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
    ...
    Button_3.Size = UDim2.new(0, 20 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
    Button_3.ZIndex = 3
    Button_3.Font = tzu
    Button_3.Text = ""
    Button_3.TextColor3 = Color3.fromRGB(255, 255, 255)
    Button_3.TextSize = 13.000 * TOUCH_SCALE
    ...
    ImageLabel_5.Position = UDim2.new(0, 4 * TOUCH_SCALE, 0, 4 * TOUCH_SCALE)
    ImageLabel_5.Size = UDim2.new(1, -8 * TOUCH_SCALE, 1, -8 * TOUCH_SCALE)
    ...
    Layer_4.Position = UDim2.new(0.5, 2 * TOUCH_SCALE, 0.5, 2 * TOUCH_SCALE)
    ...
    Text_3.Position = UDim2.new(0, 28 * TOUCH_SCALE, 0, 0)
    Text_3.Size = UDim2.new(0, 84 * TOUCH_SCALE, 1, 0)
    Text_3.Font = tzu
    Text_3.Text = "Color Picker"
    Text_3.TextColor3 = Color3.fromRGB(255, 255, 255)
    Text_3.TextSize = 13.000 * TOUCH_SCALE
    ...
    DropdownOption.Size = UDim2.new(1, 0, 0, 20 * TOUCH_SCALE)
    ...
    DropdownOption.TextSize = 13.000 * TOUCH_SCALE
    ...
    DropdownWindow.Size = UDim2.new(0, 200 * TOUCH_SCALE, 0, 22 * TOUCH_SCALE)
    ...
    Frame_6.Position = UDim2.new(0, 0, 1, -10 * TOUCH_SCALE)
    Frame_6.Size = UDim2.new(1, 0, 0, 10 * TOUCH_SCALE)
    Frame_6.ZIndex = 4
    ...
    Frame_7.Size = UDim2.new(1, 0, 0, 2 * TOUCH_SCALE)
    Frame_7.ZIndex = 2
    ...
    Title_3.Position = UDim2.new(0, 30 * TOUCH_SCALE, 0, 0)
    Title_3.Size = UDim2.new(1, -30 * TOUCH_SCALE, 1, 0)
    Title_3.ZIndex = 4
    Title_3.Font = tzu
    Title_3.Text = "Dropdown"
    Title_3.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title_3.TextSize = 15.000 * TOUCH_SCALE
    ...
    Shadow_2.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 10 * TOUCH_SCALE)
    ...
    Layer_5.Position = UDim2.new(0, 2 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    ...
    Content_2.Size = UDim2.new(1, 0, 0, 178 * TOUCH_SCALE)
    ...
    Items_4.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 30 * TOUCH_SCALE)
    Items_4.Size = UDim2.new(1, -20 * TOUCH_SCALE, 1, -60 * TOUCH_SCALE)
    Items_4.CanvasSize = UDim2.new(0, 0, 0, 0)
    Items_4.ScrollBarThickness = 6 * TOUCH_SCALE

    UIListLayout_5.Parent = Items_4
    UIListLayout_5.SortOrder = Enum.SortOrder.LayoutOrder
    UIListLayout_5.Padding = UDim.new(0, 2 * TOUCH_SCALE)

    Search.Name = "Search"
    Search.Parent = Content_2
    Search.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Search.BackgroundTransparency = 1.000
    Search.Position = UDim2.new(0, 5 * TOUCH_SCALE, 0, 6 * TOUCH_SCALE)
    Search.Size = UDim2.new(1, -10 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
    ...
    Inner_2.Position = UDim2.new(0, 2 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    Inner_2.Size = UDim2.new(1, -4 * TOUCH_SCALE, 1, -4 * TOUCH_SCALE)
    ...
    TextBox.Position = UDim2.new(0, 30 * TOUCH_SCALE, 0, 0)
    TextBox.Size = UDim2.new(1, -30 * TOUCH_SCALE, 1, 0)
    TextBox.Font = tzu
    TextBox.Text = "Search ..."
    TextBox.TextColor3 = Color3.fromRGB(178, 178, 178)
    TextBox.TextSize = 14.000 * TOUCH_SCALE
    ...
    Selected.Position = UDim2.new(0, 10 * TOUCH_SCALE, 1, -30 * TOUCH_SCALE)
    Selected.Size = UDim2.new(1, -10 * TOUCH_SCALE, 0, 30 * TOUCH_SCALE)
    Selected.Font = tzu
    Selected.Text = "Selected: [...]"
    Selected.TextColor3 = Color3.fromRGB(178, 178, 178)
    Selected.TextSize = 12.000 * TOUCH_SCALE
    ...
    Expand_3.Position = UDim2.new(0, 6 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    Expand_3.Rotation = 90.000
    Expand_3.Size = UDim2.new(0, 18 * TOUCH_SCALE, 0, 18 * TOUCH_SCALE)
    Expand_3.ZIndex = 4
    ...
    Cache.Size = UDim2.new(0, 100 * TOUCH_SCALE, 0, 100 * TOUCH_SCALE)
    Cache.Visible = false
    ...
    ColorPickerWindow.Size = UDim2.new(0, 200 * TOUCH_SCALE, 0, 22 * TOUCH_SCALE)
    ...
    Frame_8.Position = UDim2.new(0, 0, 1, -10 * TOUCH_SCALE)
    Frame_8.Size = UDim2.new(1, 0, 0, 10 * TOUCH_SCALE)
    Frame_8.ZIndex = 4
    ...
    Frame_9.Size = UDim2.new(1, 0, 0, 2 * TOUCH_SCALE)
    Frame_9.ZIndex = 2
    ...
    Title_4.Position = UDim2.new(0, 30 * TOUCH_SCALE, 0, 0)
    Title_4.Size = UDim2.new(1, -30 * TOUCH_SCALE, 1, 0)
    Title_4.ZIndex = 4
    Title_4.Font = tzu
    Title_4.Text = "Color Picker"
    Title_4.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title_4.TextSize = 15.000 * TOUCH_SCALE
    ...
    Shadow_3.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 10 * TOUCH_SCALE)
    ...
    Layer_6.Position = UDim2.new(0, 2 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    ...
    Expand_4.Position = UDim2.new(0, 6 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    Expand_4.Rotation = 90.000
    Expand_4.Size = UDim2.new(0, 18 * TOUCH_SCALE, 0, 18 * TOUCH_SCALE)
    Expand_4.ZIndex = 4
    ...
    Content_3.Size = UDim2.new(1, 0, 0, 178 * TOUCH_SCALE)
    ...
    Palette.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 10 * TOUCH_SCALE)
    Palette.Size = UDim2.new(1, -45 * TOUCH_SCALE, 1, -45 * TOUCH_SCALE)
    ...
    Indicator.Size = UDim2.new(0, 5 * TOUCH_SCALE, 0, 5 * TOUCH_SCALE)
    ...
    Saturation.Position = UDim2.new(1, -25 * TOUCH_SCALE, 0, 10 * TOUCH_SCALE)
    Saturation.Size = UDim2.new(0, 15 * TOUCH_SCALE, 1, -45 * TOUCH_SCALE)
    ...
    Indicator_2.Size = UDim2.new(1, 0, 0, 2 * TOUCH_SCALE)
    ...
    FinalColor.Position = UDim2.new(1, -25 * TOUCH_SCALE, 1, -25 * TOUCH_SCALE)
    FinalColor.Size = UDim2.new(0, 15 * TOUCH_SCALE, 0, 15 * TOUCH_SCALE)
    ...
    SaturationColor.Position = UDim2.new(1, -50 * TOUCH_SCALE, 1, -25 * TOUCH_SCALE)
    SaturationColor.Size = UDim2.new(0, 15 * TOUCH_SCALE, 0, 15 * TOUCH_SCALE)
    ...
    PaletteColor.Position = UDim2.new(1, -75 * TOUCH_SCALE, 1, -25 * TOUCH_SCALE)
    PaletteColor.Size = UDim2.new(0, 15 * TOUCH_SCALE, 0, 15 * TOUCH_SCALE)
    ...
    TextLabel.Position = UDim2.new(0, 10 * TOUCH_SCALE, 1, -35 * TOUCH_SCALE)
    TextLabel.Size = UDim2.new(1, -10 * TOUCH_SCALE, 0, 35 * TOUCH_SCALE)
    TextLabel.Font = tzu
    TextLabel.Text = "Selected:"
    TextLabel.TextColor3 = Color3.fromRGB(178, 178, 178)
    TextLabel.TextSize = 12.000 * TOUCH_SCALE
    ...
    Dropdown.Size = UDim2.new(0, 150 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
    ...
    Inner_3.Position = UDim2.new(0, 2 * TOUCH_SCALE, 0, 2 * TOUCH_SCALE)
    Inner_3.Size = UDim2.new(1, -4 * TOUCH_SCALE, 1, -4 * TOUCH_SCALE)
    ...
    Value_2.Position = UDim2.new(0, 10 * TOUCH_SCALE, 0, 0)
    Value_2.Size = UDim2.new(1, -10 * TOUCH_SCALE, 1, 0)
    Value_2.Font = tzu
    Value_2.Text = "Selected"
    Value_2.TextColor3 = Color3.fromRGB(255, 255, 255)
    Value_2.TextSize = 13.000 * TOUCH_SCALE
    ...
    Text_4.Position = UDim2.new(0, 158 * TOUCH_SCALE, 0, 0)
    Text_4.Size = UDim2.new(0, 56 * TOUCH_SCALE, 1, 0)
    Text_4.Font = tzu
    Text_4.Text = "Dropdown"
    Text_4.TextColor3 = Color3.fromRGB(255, 255, 255)
    Text_4.TextSize = 13.000 * TOUCH_SCALE
    Text_4.TextXAlignment = Enum.TextXAlignment.Left

    Cache_2.Name = "Cache"
    Cache_2.Parent = imgui2
    Cache_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Cache_2.Size = UDim2.new(0, 100 * TOUCH_SCALE, 0, 100 * TOUCH_SCALE)
...
local TOUCH_TAP_THRESHOLD = 0.3 -- seconds
local TOUCH_MOVE_THRESHOLD = 10 -- pixels
...
local function getMouse()
    if IS_MOBILE then
        ...
        if #touch > 0 then
            return Vector2.new(touch[1].Position.X, touch[1].Position.Y)
        end
...
local function isTap(position)
    if not touchStartPos then return false end
    local distance = (position - touchStartPos).Magnitude
    local timeElapsed = tick() - touchStartTime
    return distance < TOUCH_MOVE_THRESHOLD and timeElapsed < TOUCH_TAP_THRESHOLD
end
...
local dragger = {} do
    ...
    function dragger.new(frame)
        ...
        if IS_MOBILE then
            ...
            frame.TouchStarted:Connect(function(touch)
                if findBrowsingTopMost() == frame then
                    if (not colorpicking) and (not sliding) then
                        ...
                        connection = RunService.Heartbeat:Connect(function()
                            local currentTouch = UserInputService:GetTouchInputs()
                            if #currentTouch > 0 then
                                pcall(function()
                                    resize(frame, { Position = UDim2.new(0, currentTouch[1].Position.X - objectPosition.X + (frame.Size.X.Offset * frame.AnchorPoint.X), 0, currentTouch[1].Position.Y - objectPosition.Y + (frame.Size.Y.Offset * frame.AnchorPoint.Y)) }, 0.1)
                                end)
                            else
                                connection:Disconnect()
                            end
            ...
            -- Desktop mouse handling for dragging
...
local library library = {
    new = function(options)
        ...
        options = settings.new({
            text = "New Window",
            size = Vector2.new(300 * TOUCH_SCALE, 200 * TOUCH_SCALE),
            shadow = 10 * TOUCH_SCALE,
            transparency = 0.2,
            color = Color3.fromRGB(41, 74, 122),
            boardcolor = Color3.fromRGB(21, 22, 23),
            rounding = 5 * TOUCH_SCALE,
            animation = 0.1,
            position = UDim2.new(0, 100 * TOUCH_SCALE, 0, 100 * TOUCH_SCALE),
        }).handle(options)
        ...
        if IS_MOBILE then
            expand.TouchTap:Connect(function()
                if self.isopen then
                    self.close()
                else
                    self.open()
        ...
        function self.new(tabOptions)
            ...
            tabbutton.Font = tzu3
            tabbutton.TextSize = 15 * TOUCH_SCALE
            ...
            local types = { } do
                ...
                function types.button(buttonOptions)
                    ...
                    button.Size = UDim2.new(0, button.TextBounds.X + 20 * TOUCH_SCALE, 0, 20 * TOUCH_SCALE)
                ...
                function types.switch(switchOptions)
                    ...
                    text:GetPropertyChangedSignal("Text"):Connect(function()
                        switch.Size = UDim2.new(0, 28 * TOUCH_SCALE + text.TextBounds.X, 0, 20 * TOUCH_SCALE)
                    end)
                ...
                function types.slider(sliderOptions)
                    ...
                    outer.Size = UDim2.new(0, sliderOptions.size, 0, 20 * TOUCH_SCALE)
                    text.Position = UDim2.new(0, sliderOptions.size + 8 * TOUCH_SCALE, 0, 0)
                    slider.Size = UDim2.new(0, sliderOptions.size + 8 * TOUCH_SCALE + text.TextBounds.X, 0, 20 * TOUCH_SCALE)

                    local function set(p)
                        resize(_slider, { Position = UDim2.new(p, -2.5 * TOUCH_SCALE, 0, 0) }, sliderOptions.animation)
                    end
                    ...
                    -- Mobile touch handling for slider
                    if IS_MOBILE then
                        inner.TouchStarted:Connect(function(touch)
                            if inside and findBrowsingTopMost() == main then
                                ...
                                connection = RunService.Heartbeat:Connect(function()
                                    ...
                                    if #currentTouch > 0 then
                                        sliding = true
                                        local p = Vector2.new(currentTouch[1].Position.X, currentTouch[1].Position.Y)
                        ...
                        -- Desktop mouse handling for slider
                        mouse.InputBegan:Connect(function()
                            spawn(function()
                                if inside and findBrowsingTopMost() == main then
                                    while mouse.held do
                ...
                function types.color(colorOptions)
                    ...
                    text:GetPropertyChangedSignal("Text"):Connect(function()
                        colorPickerButton.Size = UDim2.new(0, 28 * TOUCH_SCALE + text.TextBounds.X, 0, 20 * TOUCH_SCALE)
                    ...
                    function self.close()
                        ...
                        colorCache.content_size = 200 * TOUCH_SCALE
                    ...
                    end colorCache.update_layers(main.AbsoluteSize.Y + colorPicker:FindFirstChild("Content").AbsoluteSize.Y)
                    ...
                    -- Add touch support for mobile
                    if IS_MOBILE then
                        colorPicker:FindFirstChild("Expand").TouchTap:Connect(function()
                            if self.isopen then
                                self.close()
                            else
                                self.open()
                    ...
                    do -- color picking
                        ...
                        -- Mobile touch handling for color picking
                        if IS_MOBILE then
                            palette.TouchStarted:Connect(function(touch)
                                if findBrowsingTopMost() == colorPicker then
                                    local connection
                                    connection = RunService.Heartbeat:Connect(function()
                                        local currentTouch = UserInputService:GetTouchInputs()
                                        if #currentTouch > 0 then
                                            ...
                                            local sv1 = math.clamp(v1, 0, (palette.AbsoluteSize.X - 6 * TOUCH_SCALE) / palette.AbsoluteSize.X)
                                            local sv2 = math.clamp(v2, 0, (palette.AbsoluteSize.Y - 6 * TOUCH_SCALE) / palette.AbsoluteSize.Y)
                            ...
                            saturation.TouchStarted:Connect(function(touch)
                                if findBrowsingTopMost() == colorPicker then
                                    local connection
                                    connection = RunService.Heartbeat:Connect(function()
                                        local currentTouch = UserInputService:GetTouchInputs()
                                        if #currentTouch > 0 then
                                            colorpicking = true
                                            local p = Vector2.new(currentTouch[1].Position.X, currentTouch[1].Position.Y)
                                            local x1 = math.clamp(p.Y - saturation.AbsolutePosition.Y, 0, saturation.AbsuteSize.Y)
                                            local v1 = x1 / saturation.AbsoluteSize.Y
                                            v = 1 - v1

                                            local sv1 = math.clamp(v1, 0, (palette.AbsoluteSize.Y - 2 * TOUCH_SCALE) / palette.AbsoluteSize.Y)
                            ...
                            -- Desktop mouse handling for color picking
                            mouse.InputBegan:Connect(function()
                                if Entered1 and findBrowsingTopMost() == colorPicker then
                                    spawn(function()
                                        ...
                                        while mouse.held do -- palette
                                            ...
                                            local sv1 = math.clamp(v1, 0, (palette.AbsuteSize.X - 6) / palette.AbsoluteSize.X)
                        ...
                        function self.set(color)
                            ...
                            local hx = math.clamp(1 - h, 0, (palette.AbsoluteSize.X - 6 * TOUCH_SCALE) / palette.AbsoluteSize.X)
                            local sx = math.clamp(1 - s, 0, (palette.AbsoluteSize.Y - 6 * TOUCH_SCALE) / palette.AbsoluteSize.Y)
                            local vx = math.clamp(1 - v, 0, (saturation.AbsoluteSize.Y - 2 * TOUCH_SCALE) / saturation.AbsoluteSize.Y)
                ...
                function types.dropdown(dropdownOptions)
                    ...
                    outer.Size = UDim2.new(0, dropdownOptions.size, 0, 20 * TOUCH_SCALE)
                    text.Position = UDim2.new(0, dropdownOptions.size + 8 * TOUCH_SCALE, 0, 0)
                    ...
                    -- Add touch support for mobile
                    if IS_MOBILE then
                        inner.TouchTap:Connect(function()
                            self.visible = not self.visible
                            dropdownWindow.Visible = self.visible
                            if self.visible then
                                dropdownWindow.Position = UDim2.new(0, dropdownButton.AbsolutePosition.X + dropdownButton.AbsoluteSize.X, 0, dropdownButton.AbsolutePosition.Y)
                    ...
                    -- Add touch support for mobile
                    if IS_MOBILE then
                        dropdownWindow:FindFirstChild("Expand").TouchTap:Connect(function()
                            if self.isopen then
                                self.close()
                            else
                                self.open()
                    ...
                    function self.close()
                        ...
                        dropdownCache.content_size = 200 * TOUCH_SCALE
                    ...
                    function self.new(name)
                        ...
                        -- Add touch support for mobile
                        if IS_MOBILE then
                            dropdownOption.TouchTap:Connect(function()
                                if findBrowsingTopMost() == dropdownWindow then
                                    dropdownObject:Select()
                                end
                            end)
                    ...
                    do -- search bar
                        ...
                        displayText.Size = UDim2.new(1, -30 * TOUCH_SCALE, 1, 0)
                        displayText.Position = UDim2.new(0, 30 * TOUCH_SCALE, 0, 0)
                        ...
                        displayText.TextSize = 14 * TOUCH_SCALE
                        displayText.ZIndex = inner.ZIndex + 1
                        displayText.Parent = inner

                        local searchIcon = Instance.new("ImageLabel")
                        searchIcon.Size = UDim2.new(0, 16 * TOUCH_SCALE, 0, 16 * TOUCH_SCALE)
                        searchIcon.Position = UDim2.new(0, 7 * TOUCH_SCALE, 0.5, -8 * TOUCH_SCALE)
                        ...
                        clearButton.Size = UDim2.new(0, 20 * TOUCH_SCALE, 1, 0)
                        clearButton.Position = UDim2.new(1, -20 * TOUCH_SCALE, 0, 0)
                        clearButton.BackgroundTransparency = 1
                        clearButton.Text = "X"
                        clearButton.TextColor3 = Color3.fromRGB(178, 178, 178)
                        clearButton.Font = Enum.Font.SourceSansBold
                        clearButton.TextSize = 14 * TOUCH_SCALE
                        ...
                        if IS_MOBILE then
                            UserInputService.TouchStarted:Connect(function(touch)
                                if canType then
                                    ...
                                    if not (touchPos.X >= innerAbsPos.X and touchPos.X <= innerAbsPos.X + innerAbsSize.X and
                                        touchPos.Y >= innerAbsPos.Y and touchPos.Y <= innerAbsPos.Y + innerAbsSize.Y) then
                                        canType = false
                                        showCursor = false
                                        updateTextDisplay()
                                    end
                ...
                function types.input(inputOptions)
                    ...
                    outer.Size = UDim2.new(0, inputOptions.size, 0, 20 * TOUCH_SCALE)
                    label.Position = UDim2.new(0, inputOptions.size + 8 * TOUCH_SCALE, 0, 0)
                    input.Size = UDim2.new(0, inputOptions.size + 8 * TOUCH_SCALE + label.TextBounds.X, 0, 20 * TOUCH_SCALE)
                    ...
                    local function updateTextDisplay()
                        if canType then
                            ...
                            local maxWidth = inner.AbsoluteSize.X - 10 * TOUCH_SCALE
                        ...
                        elseif textValue == "" then
                            ...
                            local maxWidth = inner.AbsuteSize.X - 10 * TOUCH_SCALE
                ...
                function types.dock(dockOptions)
                    ...
                    dock.ChildAdded:Connect(function()
                        ...
                        dock.Size = UDim2.new(0, size, 0, 22 * TOUCH_SCALE)
                        updateCanvas()
                    end)
                ...
                function types.folder(folderOptions)
                    ...
                    function self.close()
                        resize(folder, { Size = UDim2.new(1, 0, 0, 20 * TOUCH_SCALE) }, folderOptions.animation)
                    ...
                    function self.open()
                        ...
                        resize(folder, { Size = UDim2.new(1, 0, 0, 20 * TOUCH_SCALE + countSize(folderItems).Y + 2 * TOUCH_SCALE) }, folderOptions.animation)
...
do -- window history zindex
    ScreenGui.ChildAdded:Connect(function(window)
        ...
        if content then
            ...
            -- Mobile touch events
            if IS_MOBILE then
                window.TouchEnter:Connect(function()
                    mouseCache[window] = true
                end)
                content.TouchEnter:Connect(function()
                    browsingWindow[window] = true
                end)
                window.TouchLeave:Connect(function()
                    mouseCache[window] = false
                end)
                content.TouchLeave:Connect(function()
                    browsingWindow[window] = false
                end)
            end
